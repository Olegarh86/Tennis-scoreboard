# Review на реализацию от [@Olegarhische](https://github.com/Olegarh86/Tennis-scoreboard) проекта [Табло теннисного матча](https://zhukovsd.github.io/java-backend-learning-course/projects/tennis-scoreboard/)
